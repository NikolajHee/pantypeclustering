...
def get_args():
    ...
    parser.add_argument('-inputDimension', type=int, default=1,
    ...
    parser.add_argument('-cvWeight', type=float, default=1,
                        help='Weight of the information theoretic cost term')
    parser.add_argument('-_id', type=str, default='',
                        help='Experiment Path')
    parser.add_argument('-saveModel', type=int, default=0,
                        help='Save model in experiments folder after finish training')
    parser.add_argument('-reportLowerBound', type=int, default=1,
